...
--declare @idm int --id de municipio
--declare @nombrem varchar(100) --nombre de municipio
--declare @estadoid int --id de estado
--set @ConT=1
--WHILE @ConT <=(select count(id) from estados_municipios) --tabla intermedia estados_municipios
--BEGIN
--set @idm=0;
--set @nombrem='';
--set @estadoid =0
--select @estadoid= estados_id , @idm = municipios_id from estados_municipios where id=@ConT --obtener los datos de la tabla
----intermedia
--select @nombrem= municipio from municipios where id=@idm; --seleccionar el nombre de municipio por el id del municipio seleccionado por el contador
--insert into MunCiu(id,municipio,idEstado) values(@idm,@nombrem,@estadoid)
--set @ConT = @ConT +1 --recorrer la lista
--END
--GO
...
--create proc DesplegarCiudad
--@estado varchar(MAX)
--as
--select municipio, E.estado from MunCiu M join estados E on M.idEstado = E.id
--where E.Estado ='Jalisco' @estado

--create proc exec desplegarEstado
--as
--select estado from estados

--Create  View GenerarIDUsuarios as 
--	Select Rand()  as [RandomNumber] 
--GO
--Create  Function FuncionContraseña
--(@Length integer )
--Returns varchar(256)
--as 
--Begin
...
--Set @ValidCharacters = 'ABCDEFGHIJKLMNÑOPQRSTUVWXYZabcdefghijklmnñopqrstuvwxyz 0123456789&%$#!¡-_@¿?+*´^`~><;,:.{}[]"!/()=';; 
...
--While @Count <= @Length 
--Begin 
--	Set @RandomNumber = (Select RandomNumber from GenerarIDUsuarios); 
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Create Function FuncionIDUsuario
(@Length integer )
Returns varchar(256)
as 
Begin
...
tipo varchar(MAX),
permisoAlmacen int,
permisoProveedor int,
permisoUsuarios int,
permisoMermas int,
permisoPan int,
permisoContraseña int

)

select * from tipo_usuarios

insert into tipo_usuarios(tipo,permisoAlmacen,permisoProveedor,permisoUsuarios,permisoMermas,permisoPan,permisoContraseña) values('ADMINISTRADOR',1,1,1,1,1,1)
insert into tipo_usuarios (tipo,permisoAlmacen,permisoProveedor,permisoUsuarios,permisoMermas,permisoPan,permisoContraseña)values('CAPTURISTA',0,0,0,0,1,1)
...
edad int,
Activo int
CONSTRAINT fk_TipoUsuario FOREIGN KEY (id_TIPOUsuario) REFERENCES tipo_usuarios (id)
)
GO

select * from usuarios

INSERT INTO usuarios (id_TIPOUsuario,idUsuario,puesto, NOMBRES, APELLIDOPATER,APELLIDOMAT,sexo,CELULAR, Estado,Ciudad,CP,COLONIA,CALLE,NUM_CASA,EMAIL ,NOMBREUSUARIO,CONTRASEÑA,fechaNacimiento,edad,activo) 
VALUES((select id from tipo_usuarios where tipo='ADMINISTRADOR'),(Select master.dbo.FuncionIDUsuario (5)),(SELECT tipo FROM tipo_usuarios WHERE id =1),'admin','admin','admin','MASCULINO','6121732222','Baja California Sur','La Paz',23050,'PROGRESO','CONSTITUCION',324,'l16310181@lapaz.tecnm.mx','admin','admin','19/02/1995',26,1)

INSERT INTO usuarios (id_TIPOUsuario,idUsuario,puesto, NOMBRES, APELLIDOPATER,APELLIDOMAT,sexo,CELULAR, Estado,Ciudad,CP,COLONIA,CALLE,NUM_CASA,EMAIL ,NOMBREUSUARIO,CONTRASEÑA,fechaNacimiento,edad,activo) 
VALUES((select id from tipo_usuarios where tipo='ADMINISTRADOR'),(Select master.dbo.FuncionIDUsuario (5)),(SELECT tipo FROM tipo_usuarios WHERE id =1),'base','admin','admin','MASCULINO','6121732222','Baja California Sur','La Paz',23050,'PROGRESO','CONSTITUCION',324,'jeje@gmail.com','admin1','admin1','19/02/1995',26,1)

INSERT INTO usuarios (id_TIPOUsuario,idUsuario,puesto, NOMBRES, APELLIDOPATER,APELLIDOMAT,sexo,CELULAR, Estado,Ciudad,CP,COLONIA,CALLE,NUM_CASA,EMAIL ,NOMBREUSUARIO,CONTRASEÑA,fechaNacimiento,edad,activo) 
VALUES((select id from tipo_usuarios where tipo='ADMINISTRADOR'),(Select master.dbo.FuncionIDUsuario (5)),(SELECT tipo FROM tipo_usuarios WHERE id =1),'jose','admin','admin','MASCULINO','6241735938','Baja California Sur','La Paz',23050,'PROGRESO','CONSTITUCION',324,'jojo@gmail.com','admin2','admin2','19/02/1995',26,0)

INSERT INTO usuarios (id_TIPOUsuario,idUsuario,puesto, NOMBRES, APELLIDOPATER,APELLIDOMAT,sexo,CELULAR, Estado,Ciudad,CP,COLONIA,CALLE,NUM_CASA,EMAIL ,NOMBREUSUARIO,CONTRASEÑA,fechaNacimiento,edad,activo) 
VALUES((select id from tipo_usuarios where tipo='ADMINISTRADOR'),(Select master.dbo.FuncionIDUsuario (5)),(SELECT tipo FROM tipo_usuarios WHERE id =1),'huehue','admin','admin','MASCULINO','6122850192','Baja California Sur','La Paz',23050,'PROGRESO','CONSTITUCION',324,'ganyu@hotmail.com','admin3','admin3','19/02/1995',26,1)

INSERT INTO usuarios (id_TIPOUsuario,idUsuario,puesto, NOMBRES, APELLIDOPATER,APELLIDOMAT,sexo,CELULAR, Estado,Ciudad,CP,COLONIA,CALLE,NUM_CASA,EMAIL ,NOMBREUSUARIO,CONTRASEÑA,fechaNacimiento,edad,activo) 
VALUES((select id from tipo_usuarios where tipo='ADMINISTRADOR'),(Select master.dbo.FuncionIDUsuario (5)),(SELECT tipo FROM tipo_usuarios WHERE id =1),'tartas','admin','admin','MASCULINO','6126948220','Baja California Sur','La Paz',23050,'PROGRESO','CONSTITUCION',324,'kemelapelas@outlook.com','admin4','admin4','19/02/1995',26,1)

INSERT INTO usuarios (id_TIPOUsuario,idUsuario,puesto, NOMBRES, APELLIDOPATER,APELLIDOMAT,sexo,CELULAR, Estado,Ciudad,CP,COLONIA,CALLE,NUM_CASA,EMAIL ,NOMBREUSUARIO,CONTRASEÑA,fechaNacimiento,edad,activo) 
VALUES((select id from tipo_usuarios where tipo='ADMINISTRADOR'),(Select master.dbo.FuncionIDUsuario (5)),(SELECT tipo FROM tipo_usuarios WHERE id =1),'bruce','admin','admin','MASCULINO','6320593827','Baja California Sur','La Paz',23050,'PROGRESO','CONSTITUCION',324,'hu_tao@hotmail.com','admin5','admin5','19/02/1995',26,1)
...
@pass varchar(MAX)
as
select id,nombreusuario,contraseña,nombres,apellidoPater,apellidomat,puesto,email,idusuario,puesto from usuarios where  nombreusuario=@user and contraseña=@pass and Activo=1 
go




--create  proc recuperarContra
--@mail varchar(MAX),
--@user varchar(MAX)
--as
--select id,nombreusuario,contraseña,nombres,apellidoPater,apellidomat,puesto,email from usuarios where nombreusuario = @user or email=@mail and activo = 1
--GO

--create   proc enviarDatosUsuarioNuevo 
--@mail varchar(MAX)
--as
--select id,nombreusuario,contraseña,nombres,apellidoPater,apellidomat,puesto,email from usuarios where email=@mail and  activo = 1
--GO


--create  proc  enviarDatosUsuarioEditado
--@mail varchar(MAX),
--@id varchar(MAX)
--as
--if exists(select * from usuarios where email= @mail and @id !=idUsuario and activo = 1)
--begin
--	select id,nombreusuario,contraseña,nombres,apellidoPater,apellidomat,puesto,email from usuarios where email= 'xd'
--end
--else
--begin
--select id,nombreusuario,contraseña,nombres,apellidoPater,apellidomat,puesto,email from usuarios where email=@mail and activo = 1
...
--CREATE  PROC  REGISTRAR_USUARIOS 
--@PUESTO VARCHAR(max),
--@NOMBRE VARCHAR(max),
--@APEPATERN VARCHAR(max),
--@APEMATERN VARCHAR(max),
--@SEXO VARCHAR(max),
--@CELULAR VARCHAR(max),
--@estado VARCHAR(max),
--@ciudad VARCHAR(max),
...
--@edad int
--as
--if exists(select * from usuarios where email= @email and activo = 1)
--begin
--	update usuarios set NOMBRES ='asd' where idUsuario='asd'
--end

--else
--begin
--   INSERT INTO usuarios (id_TIPOUsuario,idUsuario,puesto, NOMBRES, APELLIDOPATER,APELLIDOMAT,sexo,CELULAR, Estado,Ciudad,CP,COLONIA,CALLE,NUM_CASA,EMAIL ,NOMBREUSUARIO,CONTRASEÑA,fechaNacimiento,edad,activo) 
--   VALUES((select id from tipo_usuarios where tipo=@PUESTO),(Select master.dbo.FuncionIDUsuario (5)),@PUESTO,@NOMBRE,@APEPATERN,@APEMATERN,@SEXO,@CELULAR,@estado,@ciudad,@cp,@colonia,@calle,@numeroCasa,@email,@nombreUsuario,(Select master.dbo.FuncionContraseña((8))),@nacimiento,@edad,1)
--end
--GO
...
--@edad int
--as
--if exists(select * from usuarios where email= @email and @id !=idUsuario and activo = 1)
--begin
--	update usuarios set NOMBRES ='333' where idUsuario='333'
--end

--else
--begin
--   update usuarios set NOMBRES =@NOMBRE,  APELLIDOPATER=@APEPATERN,APELLIDOMAT=@APEMATERN,sexo=@SEXO,CELULAR=@CELULAR, Estado=@estado,Ciudad=@ciudad,CP=@cp,COLONIA=@colonia,CALLE=@calle,NUM_CASA=@numeroCasa,EMAIL=@email ,NOMBREUSUARIO=@nombreUsuario,fechaNacimiento=@nacimiento,edad=@edad
--   where idUsuario= @id and activo = 1
--end
--GO


--create  proc  desplegarUsuarios
--as
--select idUsuario as 'ID', puesto as 'Puesto',nombres as 'Nombre', apellidoPater as 'Apellido Paterno', apellidoMat as 'Appelido Materno', sexo as 'Sexo', Celular as 'Numero de telefono celular', Estado,Ciudad,cp as 'Codigo Postal',colonia as 'Colonia', calle as 'Nombre de la calle',num_casa as 'Numero de casa',email as 'Correo electronico' from usuarios
--where Activo=1
--GO

--create  proc  verUsuariosEdit 
--@dato varchar(MAX)
--as
--select idUsuario as 'ID', puesto as 'Puesto',nombres as 'Nombre', apellidoPater as 'Apellido Paterno', apellidoMat as 'Apellido Materno', sexo as 'Sexo',fechaNacimiento as 'Fecha de nacimiento', edad as 'Edad' , Celular as 'Numero de telefono celular', Estado,Ciudad,cp as 'Codigo Postal',colonia as 'Colonia', calle as 'Nombre de la calle',num_casa as 'Numero de casa',email as 'Correo electronico' from usuarios
--where idUsuario = @dato and activo = 1
--GO
...
--@id varchar(MAX)
--as
--update usuarios set activo =0 where idUsuario = @id and idUsuario !='CWZLW'
--GO


--create   proc desplegarUsuariosFiltroNombre
--@dato varchar(MAX)
--as
--select idUsuario as 'ID', puesto as 'Puesto',nombreUsuario as 'Nombre de usuario',nombres as 'Nombre', apellidoPater as 'Apellido Paterno', apellidoMat as 'Appelido Materno', sexo as 'Sexo', Celular as 'Numero de telefono celular', Estado,Ciudad,cp as 'Codigo Postal',colonia as 'Colonia', calle as 'Nombre de la calle',num_casa as 'Numero de casa',email as 'Correo electronico' from usuarios
--where nombres like '%'+@dato+'%' and activo = 1
--GO

--create  proc desplegarUsuariosFiltroEmail
--@dato varchar(MAX)
--as
--select idUsuario as 'ID', puesto as 'Puesto',nombreUsuario as 'Nombre de usuario',nombres as 'Nombre', apellidoPater as 'Apellido Paterno', apellidoMat as 'Appelido Materno', sexo as 'Sexo', Celular as 'Numero de telefono celular', Estado,Ciudad,cp as 'Codigo Postal',colonia as 'Colonia', calle as 'Nombre de la calle',num_casa as 'Numero de casa',email as 'Correo electronico' from usuarios
--where email like '%'+@dato+'%' and activo = 1
--GO

--create  proc desplegarUsuariosFiltroNumeroTelefono
--@dato varchar(MAX)
--as
--select idUsuario as 'ID', puesto as 'Puesto',nombreUsuario as 'Nombre de usuario',nombres as 'Nombre', apellidoPater as 'Apellido Paterno', apellidoMat as 'Appelido Materno', sexo as 'Sexo', Celular as 'Numero de telefono celular', Estado,Ciudad,cp as 'Codigo Postal',colonia as 'Colonia', calle as 'Nombre de la calle',num_casa as 'Numero de casa',email as 'Correo electronico' from usuarios
--where CELULAR like '%'+@dato+'%' and activo = 1
--GO


--create proc cambiarTipoUsuario
--@tipo varchar(MAX),
--@id varchar(MAX)
--as
--update usuarios set puesto=@tipo where idUsuario=@id and Activo=1
--GO


--create  proc mostrarContraseña
--@id varchar(MAX)
--as
--select idUsuario as 'ID', nombres,apellidoPater,apellidoMat,contraseña from usuarios where idUsuario =@id and Activo=1;
--GO

--create proc cambiarContraseña
--@id varchar(MAX),
--@contraseña varchar(MAX)
--as
--update usuarios set contraseña =@contraseña where idUsuario= @id and Activo=1;
--GO

create  proc editarPermisos
 @tipo varchar(MAX),
@permisoA varchar(MAX),
@acceso int
 AS 
BEGIN
...
SET @queryString = 'update tipo_usuarios set '  + @permisoA +' =  @acceso   WHERE tipo =  @tipo';

 
EXECUTE sp_executesql @queryString,
        N'@tipo varchar(MAX),@acceso INT',
         @tipo = @tipo,
         @acceso = @acceso;
...
create proc mostrarPermisos	
as
select tipo as 'Rol', permisoAlmacen as 'Acceso a Almacen',permisoProveedor as 'Acceso a Proveedor', permisoUsuarios as 'Acceso a Usuarios', permisoMermas as 'Acceso a Mermas', permisoPan as 'Acceso a Pan' from tipo_usuarios
GO

create proc mostrarPermisosLogin
@tipo varchar(MAX)
as
select tipo as 'Rol', permisoAlmacen as 'Acceso a Almacen',permisoProveedor as 'Acceso a Proveedor', permisoUsuarios as 'Acceso a Usuarios', permisoMermas as 'Acceso a Mermas', permisoPan as 'Acceso a Pan' from tipo_usuarios
where tipo=@tipo
...
numeroTelefono varchar(MAX)     
) 
GO

--USE PanaderiaDB
insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('HARINA PACEÑA','OMAR','AVILES','MARRON','HARINA','KILO','CHIPANES','PRUEBAS CINCO',22022,'',252,22.00,'6121095823')

insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('ZUKA','JOSE','SANCHEZ','FLORES','AZUCAR','KILO','LIBERTAD','PRUEBAS SEIS',21321,'',118,31.50,'624958203')

insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('ZUKA','JOSE','SANCHEZ','FLORES','AZUCAR MORENA','KILO','LIBERTAD','PRUEBAS SEIS',21321,'',118,37.00,'624958203')
 
insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('KEEMAKI','LAURA','CONTRERAS','GARCIA','LEVADURA','KILO','CARABINEROS ','PRUEBAS SIETE',39174,'',398,310.00,'6129482731')

insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('LALA','LUIS ADRIAN','MARRON','LEYVA','LECHE ENTERA','LITRO','PICO DE ORIZABA ','PRUEBAS OCHO',33187,'34',987,15.00,'6122948501')

insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('AGUA CIEL','JESUS','CASTRO','CASTILLO','GARRAFON','UNIDAD','CARRETERA SAN JUAN DE LOS PLANES ','ZONA INDUSTRIAL',23050,'',23050,55.00,'6122948677')

insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('AGUA CIEL','JESUS','CASTRO','CASTILLO','AGUA','LITRO','CARRETERA SAN JUAN DE LOS PLANES ','ZONA INDUSTRIAL',23050,'',23050,1.00,'6122948677')

insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('LA FINA','MARIA','ALVARES','VEGA','SAL','KILO','CONCEPCIÓN 2 ','VALLE DEL MEZQUITE',23084,'',552,15.00,'6120958173')


insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('EUGENIA','JUAN PABLO','SANCHEZ','SANCHEZ','MANTEQUILLA','KILO','CONSTITUCION #13 ','DIANA LAURA',23034,'',231, 138.00,'6120952212')


insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('BACHOCO','ANGEL GABRIEL','SANCHEZ','SANCHEZ','HUEVO','PIEZA','CONSTITUCION #13 ','DIANA LAURA',23034,'',231, 2.00,'6120451212')


insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('NUTRIOLI','CRISTINA','PEREZ','OBREGON','ACEITE VEGETAL','LITRO','MENSAJEROS #22 ','8 DE OCTUBRE',23034,'',231, 23.00,'6121452512')

insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('POSTRELICIOSO','ESTEFANIA','REYNADA','CASTRO','AZUCAR GLASS','KILO','BULEVAR LIBERTARIOS ','LA FUENTE',22091,'',661, 90.00,'6122665953')

insert into proveedor(NombreMarca,nombres,APELLIDOPAT,APELLIDOMAT,PRODUCTO,TIPOCANTIDAD,CALLE,
COLONIA,CP,NUM_INTERIOR,NUM_EXTERIOR,Precio_unitario,NUMEROTELEFONO)VALUES('VAINILLA MOLINA','ESTEFANIA','REYNADA','CASTRO','EXTRACTO DE VAINILLA','LITRO','BULEVAR LIBERTARIOS ','LA FUENTE',22091,'',661, 1500.00,'6122665953')
...
--USE PanaderiaDB
INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(1,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=1 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=1),'KILO',10,'02-04-2021','02-04-2022')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(1,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=1 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=1),'KILO',5.8,'01-13-2021','01-13-2022')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(2,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=2 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=2),'KILO',10,'01-13-2021','')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(3,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=3 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=3),'KILO',10,'01-13-2021','')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(4,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=4 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=4),'KILO',4,'01-13-2021','01-13-2022')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(5,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=5 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=5),'LITRO',20,'01-13-2021','07-13-2021')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(6,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=6 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=6),'UNIDAD',10,'01-13-2021','01-13-2023')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(7,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=7 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=7),'LITROS',200,'01-13-2021','01-13-2023')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(8,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=8 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=8),'KILOS',50,'01-13-2021','')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(9,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=9 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=9),'KILOS',200,'01-13-2021','04-13-2021')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(10,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=10 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=10),'PIEZA',300,'01-13-2021','04-13-2021')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(11,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=11 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=11),'LITROS',20,'01-13-2021','01-13-2022')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(12,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=12 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=12),'LITROS',20,'01-13-2021','')

INSERT INTO ALMACEN(idProveedor,MARCA,nombreProducto,tipoCantidad,CANTIDAD,FECHA_ENTRADA,FECHA_CADUCIDAD) VALUES(13,(SELECT NOMBREMARCA FROM PROVEEDOR WHERE ID=13 ),
(SELECT PRODUCTO FROM PROVEEDOR WHERE ID=13),'LITROS',1,'01-13-2021','01-13-2030')

--GO

-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
USE PanaderiaDB
create table registrarPan
(
id int identity (1,1) primary key,
nombre_pan varchar(MAX),
...
INSERT INTO registrarPan(nombre_pan,precio_unitario,activo,foto) VALUES('CONCHITA DE VAINILLA',8,1,(SELECT BulkColumn from openrowset( Bulk 'C:\Imagenes\Imagen 12x.PNG', Single_Blob) as img))
INSERT INTO registrarPan(nombre_pan,precio_unitario,activo,foto) VALUES('QUEQUITO',3,1,(SELECT BulkColumn from openrowset( Bulk 'C:\Imagenes\Imagen 22x.PNG', Single_Blob) as img))
INSERT INTO registrarPan(nombre_pan,precio_unitario,activo,foto) VALUES('OJO DE BUEY',8,1,(SELECT BulkColumn from openrowset( Bulk 'C:\Imagenes\ojodeBuey.jpg', Single_Blob) as img))
INSERT INTO registrarPan(nombre_pan,precio_unitario,activo,foto) VALUES('CUERNITO',8,1,(SELECT BulkColumn from openrowset( Bulk 'C:\Imagenes\Imagen 32x.PNG', Single_Blob) as img))
INSERT INTO registrarPan(nombre_pan,precio_unitario,activo,foto) VALUES('DONA DE AZUCAR',8,1,(SELECT BulkColumn from openrowset( Bulk 'C:\Imagenes\Imagen 42x.PNG', Single_Blob)as img )


create  proc proceRegistrarPan
@nombre_pan varchar(MAX),
@precio_unitario decimal(10,3),
@imagen varchar(MAX)
as
...
SET @queryString = 'insert into registrarPan(nombre_pan,precio_unitario,activo,foto) values(@nombre_pan,@precio_unitario,1,(SELECT BulkColumn from openrowset( Bulk '''+@imagen+''', Single_Blob)as img))'  

EXECUTE sp_executesql @queryString,
        N'@nombre_pan varchar(MAX),@precio_unitario decimal(10,3)',
         @nombre_pan = @nombre_pan,
...
create proc PanRegistrado
as
select id as 'ID',nombre_pan as 'Nombre', precio_unitario as 'Precio Uitario', Foto from registrarPan where activo=1
...
num_piezas int,
id_producto int,
CONSTRAINT fk_receta FOREIGN KEY (id_pan ) REFERENCES registrarpan (id),
CONSTRAINT fk_ingredientes FOREIGN KEY (id_producto ) REFERENCES almacen (idProducto)

)
--GO
--USE PanaderiaDB
insert into receta(id_pan,nombreProducto,cantidad,num_piezas,id_producto) 
values((SELECT id from registrarPan where nombre_pan='CONCHITA DE VAINILLA'),'HARINA',0.640, 10,(select idPrODUCTO from almacen where FECHA_ENTRADA=(select min(FECHA_ENTRADA) from almacen)and nombreProducto='HARINA'))
insert into receta(id_pan,nombreProducto,cantidad,num_piezas,id_producto) 
values((SELECT id from registrarPan where nombre_pan='CONCHITA DE VAINILLA'),'MANTEQUILLA',0.266, 10,(select idPrODUCTO from almacen where FECHA_ENTRADA=(select min(FECHA_ENTRADA) from almacen)and nombreProducto='MANTEQUILLA'))
insert into receta(id_pan,nombreProducto,cantidad,num_piezas,id_producto) 
values((SELECT id from registrarPan where nombre_pan='CONCHITA DE VAINILLA'),'LEVADURA',0.014, 10,(select idPrODUCTO from almacen where FECHA_ENTRADA=(select min(FECHA_ENTRADA) from almacen)and nombreProducto='LEVADURA'))
insert into receta(id_pan,nombreProducto,cantidad,num_piezas,id_producto) 
values((SELECT id from registrarPan where nombre_pan='CONCHITA DE VAINILLA'),'AZUCAR',0.050, 10,(select idPrODUCTO from almacen where FECHA_ENTRADA=(select min(FECHA_ENTRADA) from almacen)and nombreProducto='AZUCAR'))
insert into receta(id_pan,nombreProducto,cantidad,num_piezas,id_producto) 
values((SELECT id from registrarPan where nombre_pan='CONCHITA DE VAINILLA'),'SAL',0.011, 10,(select idPrODUCTO from almacen where FECHA_ENTRADA=(select min(FECHA_ENTRADA) from almacen)and nombreProducto='SAL'))
insert into receta(id_pan,nombreProducto,cantidad,num_piezas,id_producto) 
values((SELECT id from registrarPan where nombre_pan='CONCHITA DE VAINILLA'),'HUEVO',4, 10,(select idPrODUCTO from almacen where FECHA_ENTRADA=(select min(FECHA_ENTRADA) from almacen)and nombreProducto='HUEVO'))
insert into receta(id_pan,nombreProducto,cantidad,num_piezas,id_producto) 
values((SELECT id from registrarPan where nombre_pan='CONCHITA DE VAINILLA'),'AZUCAR GLASS',0.150, 10,(select idPrODUCTO from almacen where FECHA_ENTRADA=(select min(FECHA_ENTRADA) from almacen)and nombreProducto='AZUCAR GLASS'))
insert into receta(id_pan,nombreProducto,cantidad,num_piezas,id_producto) 
values((SELECT id from registrarPan where nombre_pan='CONCHITA DE VAINILLA'),'EXTRACTO DE VAINILLA',0.015, 10,(select idPrODUCTO from almacen where FECHA_ENTRADA=(select min(FECHA_ENTRADA) from almacen)and nombreProducto='EXTRACTO DE VAINILLA'))
...
USE PanaderiaDB
create  table stockPanes(
id int identity (1,1) primary key,
id_pan int,
nombrepan VARchar(MAX),
cantidad int
CONSTRAINT fk_stock FOREIGN KEY (id_pan ) REFERENCES registrarpan (id),
)
GO

insert into stockpanes(id_pan,nombrepan,cantidad) values(1,(select nombre_pan from registrarPan where id=1),20)
insert into stockpanes(id_pan,nombrepan,cantidad) values(2,(select nombre_pan from registrarPan where id=2),10)
insert into stockpanes(id_pan,nombrepan,cantidad) values(3,(select nombre_pan from registrarPan where id=3),8)
insert into stockpanes(id_pan,nombrepan,cantidad) values(4,(select nombre_pan from registrarPan where id=4),2)
insert into stockpanes(id_pan,nombrepan,cantidad) values(5,(select nombre_pan from registrarPan where id=5),13)


 create  proc agregarStockaPan
 @nombre varchar(MAX),
 @cantidad int
 as
 update stockPanes set cantidad = cantidad+@cantidad  where nombrepan=@nombre
GO



create   proc stockPan 
as
select p.id as 'ID', s.nombrepan as 'Nombre', s.cantidad as 'Cantidad',p.precio_unitario as 'Precio', p.Foto  from stockPanes s inner join registrarPan p on s.id_pan = p.id WHERE activo=1;
GO

create   proc restarPan
@nombre varchar(MAX)
as
update stockPanes set cantidad = (cantidad-1) where nombrepan= @nombre;
GO

create  proc agregarPan
@nombre varchar(MAX)
as
update stockPanes set cantidad = (cantidad+1) where nombrepan=@nombre;
GO
...
create table RecibidoCambio
(
recibido decimal(14,2),
cambio decimal(14,2)
)
create proc RecibidoCambi
@recibido decimal(14,2),
@cambio decimal(14,2)
as
insert into RecibidoCambio(recibido,cambio) values(@recibido,@cambio)
GO

create proc verRecibidoYCambio
as
select * from RecibidoCambio
GO

create proc limpiarrecibiCambi
as
delete from RecibidoCambio
GO

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------PROCEDIMIENTO PARA LA CORRECTA GESTION DE INSUMOS AL MOMENTO DE CREAR PANES----------------------------------------------------------------------------------
------create table tempoAlmacenProductos(
------	idProducto int,
------	cantidad DECIMAL(10,3),
------	fecha_entrada date
------	)
------create table tempoReceta(
------nombreProducto varchar(MAX),
------cantiProducto DECIMAL(10,3),
------cantidadPan int,
------);

------create table suficiente
------(
------sufi int
------)
------insert into suficiente values(1)
------update suficiente set sufi =1;
----insert into tempoReceta(nombreProducto,cantiProducto,cantidadPan) select nombreProducto,cantidad,num_piezas from receta where id_pan = 1;
----declare @j INT;
----set @j = (select COUNT(*) from tempoReceta);
----declare @sufi INT;
----set @sufi=(select * from suficiente)

----while @j>0 and @sufi !=0
----BEGIN
----	declare @NombreProductos varchar(MAX)= (SELECT top(1) NOMBREPRODUCTO FROM tempoReceta)
----	declare @CANTIDADPRODUCTO DECIMAL(10,3)=(SELECT top(1) cantiProducto FROM tempoReceta)
----	declare @cantidadpan int=(SELECT top(1) cantidadPan FROM tempoReceta)
----	declare @cantidad int=20
----	insert into tempoAlmacenProductos(idProducto,cantidad,fecha_entrada) select idproducto, CANTIDAD,FECHA_ENTRADA from almacen where nombreProducto=@NombreProductos;
----	DELETE FROM tempoAlmacenProductos WHERE cantidad=0;
----	declare @idproductotempo int= (select idproducto from tempoAlmacenProductos where fecha_entrada=(select min(fecha_entrada) FROM tempoAlmacenProductos))
----	declare @productosDiferentes int = (select COUNT(*) from tempoAlmacenProductos)
----	IF(SELECT CANTIDAD FROM tempoAlmacenProductos WHERE FECHA_ENTRADA=(select min(FECHA_ENTRADA) from tempoAlmacenProductos where idProducto=@idproductotempo)) >(@CANTIDADPRODUCTO * (@cantidad/@cantidadPAN))
----		BEGIN
----		--PRINT @NombreProductos + CONVERT(VARCHAR,@contador) + CONVERT(VARCHAR,@cantidad)
----		update almacen
----				set CANTIDAD = CANTIDAD-(@CANTIDADPRODUCTO * (@cantidad/@cantidadPAN))
----				where idproducto= (select idProducto from almacen where idProducto=@idproductotempo);
----				insert into stockPanes(id_pan,nombrepan,cantidad) values(1,(select nombre_pan from registrarPan where id=1),20)
----		DELETE top(1) FROM tempoReceta
----		DELETE FROM tempoAlmacenProductos;
----		update suficiente set sufi =1;
----		set @j = (select COUNT(*) from tempoReceta);
----		END
----	ELSE
...
----		IF @productosDiferentes >1 --AND (SELECT CANTIDAD FROM tempoAlmacenProductos WHERE FECHA_ENTRADA=(select min(FECHA_ENTRADA) from tempoAlmacenProductos)) > 0
----		BEGIN
----			update almacen
----				set CANTIDAD = 0
----				where idproducto= (select idProducto from almacen where idProducto=@idproductotempo);
...
----			update almacen
----			set CANTIDAD =(CANTIDAD+(select cantidad from tempoAlmacenProductos where idProducto=@idproductotempo))--(select cantidad from almacen where nombreProducto=@NombreProductos and FECHA_ENTRADA=(select min(FECHA_ENTRADA) from almacen)and CANTIDAD>0))
----				where idproducto= (select idProducto from almacen where nombreProducto=@NombreProductos and FECHA_ENTRADA=(select min(FECHA_ENTRADA) from almacen where nombreProducto=@NombreProductos and CANTIDAD>0));
----			--DELETE top(1) FROM tempoReceta
----			--set @j = (select COUNT(*) from tempoReceta);
----			DELETE FROM tempoAlmacenProductos;
----		END
...
----			PRINT @NombreProductos + ' INSUFICIENTE';
----			DELETE tempoAlmacenProductos;
----			set @j = 0;
----			update suficiente set sufi =0;
			
----	END
		 
----END

----DELETE FROM tempoReceta;
----SELECT * FROM ALMACEN where nombreProducto='mantequilla';
----SELECT * FROM ALMACEN where nombreProducto='harina';
...
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan) values(1,19,(select (NOMBRES+' '+apellidoPater+' '+apellidoMat)as Empleado from usuarios where id=19),'CONCHITA DE VAINILLA',8,10,(8*10),(SELECT CONVERT(varchar, getdate(), 23)),1)
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan) values(2,20,(select (NOMBRES+' '+apellidoPater+' '+apellidoMat)as Empleado from usuarios where id=20),'CONCHITA DE VAINILLA',8,10,(8*10),'01-13-2021',1)
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan) values(3,21,(select (NOMBRES+' '+apellidoPater+' '+apellidoMat)as Empleado from usuarios where id=21),'OREJITAS DE HOJALDRE',3,10,(8*10),'02-13-2021',2)
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan) values(4,22,(select (NOMBRES+' '+apellidoPater+' '+apellidoMat)as Empleado from usuarios where id=22),'OJO DE BUEY',8,15,(8*15),'03-13-2021',3)
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan) values(5,23,(select (NOMBRES+' '+apellidoPater+' '+apellidoMat)as Empleado from usuarios where id=23),'DONA DE AZUCAR',8,30,(8*10),'03-20-2021',5)
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan) values(6,23,(select (NOMBRES+' '+apellidoPater+' '+apellidoMat)as Empleado from usuarios where id=23),'CONCHITA DE VAINILLA',8,5,(8*5),'01-22-2021',1)
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan) values(7,26,(select (NOMBRES+' '+apellidoPater+' '+apellidoMat)as Empleado from usuarios where id=26),'OREJITAS DE HOJALDRE',29,10,(8*29),'02-29-2021',2)
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan) values(8,26,(select (NOMBRES+' '+apellidoPater+' '+apellidoMat)as Empleado from usuarios where id=26),'OJO DE BUEY',8,15,(8*15),'03-19-2021',3)
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan) values(9,26,(select (NOMBRES+' '+apellidoPater+' '+apellidoMat)as Empleado from usuarios where id=26),'DONA DE AZUCAR',8,18,(8*18),'03-30-2021',11)
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan) values(9,26,(select (NOMBRES+' '+apellidoPater+' '+apellidoMat)as Empleado from usuarios where id=26),'DONA DE AZUCAR',8,18,(8*18),'03-30-2021',11)
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan) values(9,26,(select (NOMBRES+' '+apellidoPater+' '+apellidoMat)as Empleado from usuarios where id=26),'DONA DE AZUCAR',8,18,(8*18),'03-30-2021',11)
...
as
select numero_venta as 'Numero de venta',nombre_empleado as 'Empleado', concepto as 'Concepto', precio_unitario as 'Precio unitario', cantidad as 'Cantidad', subtotal as 'Subtotal', fecha as 'Fecha' from ventas
GO

select max(numero_venta) from ventas

create table ventatempor
(
id_venta int IDENTITY(1,1) primary key,
numero_venta int,
id_empleado int,
...
insert into ventatempor (numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan)
values((select max(numero_venta)+1 from ventas),@idEmple,@nombreEmpleado,@concepto,@precioUni,@cantidad,(@precioUni*@cantidad),@fecha,@idpan);

select * from 

exec stockpan
create  proc  quitarArticulo
@id int,
@cantidad int,
@nombrePan varchar(MAX)

as
update stockPanes set cantidad = (cantidad+@cantidad) where nombrepan=@nombrePan;
delete from ventatempor where  id_venta=@id;

GO

create  proc venderArticulo
as
insert into ventas(numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan)
select numero_venta,id_empleado,nombre_empleado,concepto,precio_unitario,cantidad,subtotal,fecha,id_Pan from ventatempor;

delete from ventatempor;
GO

create  proc  tablaVender
as
select id_venta as 'Numero del artículo', numero_venta as 'Numero de venta',concepto as 'Artículo', precio_unitario as 'Precio unitario', cantidad as 'Cantidad', subtotal as 'Subtotal'  from ventatempor
GO

create  proc  ticketVender
as
select numero_venta as 'Numero_de_venta',concepto as 'Artículo', precio_unitario as 'Precio_unitario', cantidad as 'Cantidad', subtotal as 'Subtotal'  from ventas
where numero_venta=(select MAX(numero_venta) from ventas) 
GO
create proc EmpleadoAtendio
as
select distinct nombre_empleado as 'Empleado_que_lo_atendio' from ventas where numero_venta=(select MAX(numero_venta) from ventas) 
GO
select * from ventas
...
select sum(subtotal) +(sum(subtotal) *.16) as'Total_IVA_incluido' from ventas where numero_venta=(select MAX(numero_venta) from ventas) 
GO

create proc fechaVenta
as
select distinct fecha as 'Fecha' from ventas where numero_venta=(select MAX(numero_venta) from ventas) 
GO

create proc temporalVentas 
as
delete from ventatempor
GO
...
--	select concepto,sum(cantidad) as Cantidad, sum(subtotal) as Ingreso  from ventas 
--	where fecha like '%03%'
--	group by concepto
...
--fecha date,
--razon varchar(MAX),
--CONSTRAINT fk_mermasPan FOREIGN KEY (idpan  ) REFERENCES stockPanes (id)
--)
--GO

--USE PanaderiaDB
--create table mermasAlmacen
--(
--id int IDENTITY(1,1) primary key,
--idproducto int,
--MARCA varchar(MAX),
...
--fecha date,
--razon varchar(MAX),
--CONSTRAINT fk_mermasProducto FOREIGN KEY (idproducto  ) REFERENCES almacen (idproducto)
--)
--GO